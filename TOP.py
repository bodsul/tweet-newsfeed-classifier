...
class TOP:
    ...
    def gettopwords(self):
        ...
        for KEY in self.tokenized_tweets.keys():
            words = []
            if(KEY!= '9'):
                a = self.tokenized_tweets[KEY]
                for i in range(0, len(a)):
                    words+= [word for word in a[i]]

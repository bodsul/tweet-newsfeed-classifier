...
"""train = [('Alteryx (Irvine, CA) raises $60 M to meet growing global demand for Data Blending and Advanced Analytics BigDataCo', 'business and economy'),
    ('A huge new neutrino experiment, Nona, is up and running at Fermilab | Jon Butterworth | Life and Physics', 'science and tech'),

    ('RT Bruce_Bower: An ancient Maya ruler was foreign right down to his bones:','fact or information sharing')]"""
